...
type Base_Match3_RoomInfo struct {
	...
	RoleList          map[int32]*Base_Match3_RoleInfo `protobuf:"bytes,9,rep,name=RoleList,proto3" json:"RoleList,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //角色信息列表
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type Base_Match3_SetChesses struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	ChangeChesses map[int32]*Base_Match3_Chess `protobuf:"bytes,1,rep,name=ChangeChesses,proto3" json:"ChangeChesses,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //一组棋子信息，key是位置，value是数据
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Base_Match3_ChessboardInfo struct {
	...
	FirstEliminated     map[int32]*Base_Match3_RepeatInt     `protobuf:"bytes,5,rep,name=FirstEliminated,proto3" json:"FirstEliminated,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //行动所消除掉的珠子
	NextEliminated      map[int32]*Base_Match3_RepeatInt     `protobuf:"bytes,6,rep,name=NextEliminated,proto3" json:"NextEliminated,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`   //行动消除掉的珠子中有特殊棋子消除的后续消除
	SupplyChesses       map[int32]*Base_Match3_SupplyChesses `protobuf:"bytes,7,rep,name=SupplyChesses,proto3" json:"SupplyChesses,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`     //行动之后补充的所有棋子
	ChessGrid           map[int32]*Base_Match3_Chess         `protobuf:"bytes,8,rep,name=ChessGrid,proto3" json:"ChessGrid,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`             //棋盘数据
	ChangeChesses       map[int32]*Base_Match3_Chess         `protobuf:"bytes,9,rep,name=ChangeChesses,proto3" json:"ChangeChesses,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	TargetChangeChesses map[int32]*Base_Match3_SetChesses    `protobuf:"bytes,10,rep,name=TargetChangeChesses,proto3" json:"TargetChangeChesses,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` //目标的棋子变化,key椅子号，value变化棋子//某些技能效果是棋子变化
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
type Base_Match3_HeroSkillInfo struct {
	state             protoimpl.MessageState                    `protogen:"open.v1"`
	Id                int32                                     `protobuf:"varint,1,opt,name=Id,proto3" json:"Id,omitempty"`
	HeroSkillItemList map[string]*Base_Match3_HeroSkillItemInfo `protobuf:"bytes,2,rep,name=HeroSkillItemList,proto3" json:"HeroSkillItemList,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type Base_Match3_JieSuanRoleInfo struct {
	...
	RewardItemList map[int32]int32        `protobuf:"bytes,5,rep,name=RewardItemList,proto3" json:"RewardItemList,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"` //奖励物品列表 key:是ItemId;v:数量num;
...
type Net_Match3_GameOverRet struct {
	state         protoimpl.MessageState                  `protogen:"open.v1"`
	JieSuan       map[string]*Base_Match3_JieSuanRoleInfo `protobuf:"bytes,1,rep,name=JieSuan,proto3" json:"JieSuan,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_Net_Match3_proto_rawDesc = "" +
	"\n" +
	"\x10Net_Match3.proto\x12\x02Pb\"N\n" +
	"\x16Base_Match3_Match3Info\x124\n" +
	"\bRoomInfo\x18\x01 \x01(\v2\x18.Pb.Base_Match3_RoomInfoR\bRoomInfo\"\xb5\x03\n" +
	"\x14Base_Match3_RoomInfo\x12\x16\n" +
	"\x06RoomId\x18\x01 \x01(\x05R\x06RoomId\x12\x1e\n" +
	"\n" +
	"RoomTypeId\x18\x02 \x01(\x05R\n" +
	"RoomTypeId\x12\x1e\n" +
	"\n" +
	"RoomStatus\x18\x03 \x01(\x05R\n" +
	"RoomStatus\x12,\n" +
	"\x11CurrentServerTime\x18\x04 \x01(\x03R\x11CurrentServerTime\x12\x1c\n" +
	"\tStartTime\x18\x05 \x01(\x03R\tStartTime\x12\x18\n" +
	"\aEndTime\x18\x06 \x01(\x03R\aEndTime\x12\"\n" +
	"\fCountdownNum\x18\a \x01(\x05R\fCountdownNum\x12 \n" +
	"\vChairMaxNum\x18\b \x01(\x05R\vChairMaxNum\x12B\n" +
	"\bRoleList\x18\t \x03(\v2&.Pb.Base_Match3_RoomInfo.RoleListEntryR\bRoleList\x1aU\n" +
	"\rRoleListEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12.\n" +
	"\x05value\x18\x02 \x01(\v2\x18.Pb.Base_Match3_RoleInfoR\x05value:\x028\x01\"\xc6\x01\n" +
	"\x16Base_Match3_SetChesses\x12S\n" +
	"\rChangeChesses\x18\x01 \x03(\v2-.Pb.Base_Match3_SetChesses.ChangeChessesEntryR\rChangeChesses\x1aW\n" +
	"\x12ChangeChessesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.Pb.Base_Match3_ChessR\x05value:\x028\x01\"\xdb\t\n" +
	"\x1aBase_Match3_ChessboardInfo\x12\x1a\n" +
	"\bMoveType\x18\x01 \x01(\x05R\bMoveType\x12\x1a\n" +
	"\bBeginPos\x18\x02 \x01(\x05R\bBeginPos\x12\x16\n" +
	"\x06EndPos\x18\x03 \x01(\x05R\x06EndPos\x12\x18\n" +
	"\aSkillId\x18\x04 \x01(\x05R\aSkillId\x12]\n" +
	"\x0fFirstEliminated\x18\x05 \x03(\v23.Pb.Base_Match3_ChessboardInfo.FirstEliminatedEntryR\x0fFirstEliminated\x12Z\n" +
	"\x0eNextEliminated\x18\x06 \x03(\v22.Pb.Base_Match3_ChessboardInfo.NextEliminatedEntryR\x0eNextEliminated\x12W\n" +
	"\rSupplyChesses\x18\a \x03(\v21.Pb.Base_Match3_ChessboardInfo.SupplyChessesEntryR\rSupplyChesses\x12K\n" +
	"\tChessGrid\x18\b \x03(\v2-.Pb.Base_Match3_ChessboardInfo.ChessGridEntryR\tChessGrid\x12W\n" +
	"\rChangeChesses\x18\t \x03(\v21.Pb.Base_Match3_ChessboardInfo.ChangeChessesEntryR\rChangeChesses\x12i\n" +
	"\x13TargetChangeChesses\x18\n" +
	" \x03(\v27.Pb.Base_Match3_ChessboardInfo.TargetChangeChessesEntryR\x13TargetChangeChesses\x1a]\n" +
	"\x14FirstEliminatedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.Pb.Base_Match3_RepeatIntR\x05value:\x028\x01\x1a\\\n" +
	"\x13NextEliminatedEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.Pb.Base_Match3_RepeatIntR\x05value:\x028\x01\x1a_\n" +
	"\x12SupplyChessesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x123\n" +
	"\x05value\x18\x02 \x01(\v2\x1d.Pb.Base_Match3_SupplyChessesR\x05value:\x028\x01\x1aS\n" +
	"\x0eChessGridEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.Pb.Base_Match3_ChessR\x05value:\x028\x01\x1aW\n" +
	"\x12ChangeChessesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.Pb.Base_Match3_ChessR\x05value:\x028\x01\x1ab\n" +
	"\x18TargetChangeChessesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x120\n" +
	"\x05value\x18\x02 \x01(\v2\x1a.Pb.Base_Match3_SetChessesR\x05value:\x028\x01\"\xbe\x02\n" +
	"\x14Base_Match3_HeroInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\x05R\x02Id\x12\x12\n" +
	"\x04Name\x18\x02 \x01(\tR\x04Name\x12\x14\n" +
	"\x05Level\x18\x03 \x01(\x05R\x05Level\x12\x0e\n" +
	"\x02Hp\x18\x04 \x01(\x05R\x02Hp\x12\x18\n" +
	"\aHpLimit\x18\x05 \x01(\x05R\aHpLimit\x12\x10\n" +
	"\x03Atk\x18\x06 \x01(\x05R\x03Atk\x12\x12\n" +
	"\x04Step\x18\a \x01(\x05R\x04Step\x12\"\n" +
	"\fRecoveryTime\x18\b \x01(\x05R\fRecoveryTime\x12\x1e\n" +
	"\n" +
	"HeadIconId\x18\t \x01(\x05R\n" +
	"HeadIconId\x12\x18\n" +
	"\aQuality\x18\n" +
	" \x01(\x05R\aQuality\x12\x16\n" +
	"\x06Detect\x18\v \x01(\tR\x06Detect\x12\x14\n" +
	"\x05Skill\x18\f \x01(\tR\x05Skill\x12\x10\n" +
	"\x03Buy\x18\r \x01(\x05R\x03Buy\"\x8d\x02\n" +
	"\x18Base_Match3_SkillBarInfo\x12O\n" +
	"\x10ChessboardSkill1\x18\x01 \x01(\v2#.Pb.Base_Match3_ChessboardSkillInfoR\x10ChessboardSkill1\x12O\n" +
	"\x10ChessboardSkill2\x18\x02 \x01(\v2#.Pb.Base_Match3_ChessboardSkillInfoR\x10ChessboardSkill2\x12O\n" +
	"\x10ChessboardSkill3\x18\x03 \x01(\v2#.Pb.Base_Match3_ChessboardSkillInfoR\x10ChessboardSkill3\"\x85\x03\n" +
	"\x1fBase_Match3_ChessboardSkillInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\x05R\x02Id\x12\x12\n" +
	"\x04Name\x18\x02 \x01(\tR\x04Name\x12 \n" +
	"\vDescription\x18\x03 \x01(\tR\vDescription\x12\x1c\n" +
	"\tClearType\x18\x04 \x01(\x05R\tClearType\x12\x14\n" +
	"\x05Point\x18\x05 \x01(\x05R\x05Point\x12 \n" +
	"\vActiveColor\x18\x06 \x01(\x05R\vActiveColor\x12\x1c\n" +
	"\tActiveNum\x18\a \x01(\x05R\tActiveNum\x12$\n" +
	"\rBoardSkillIId\x18\b \x01(\x05R\rBoardSkillIId\x12\x1c\n" +
	"\tSkillIcon\x18\t \x01(\tR\tSkillIcon\x12 \n" +
	"\vBottomFrame\x18\n" +
	" \x01(\tR\vBottomFrame\x12$\n" +
	"\rEffectsKillok\x18\v \x01(\x05R\rEffectsKillok\x12\x1c\n" +
	"\tDelayTime\x18\f \x01(\x05R\tDelayTime\"\xf8\x01\n" +
	"\x19Base_Match3_HeroSkillInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\x05R\x02Id\x12b\n" +
	"\x11HeroSkillItemList\x18\x02 \x03(\v24.Pb.Base_Match3_HeroSkillInfo.HeroSkillItemListEntryR\x11HeroSkillItemList\x1ag\n" +
	"\x16HeroSkillItemListEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x127\n" +
	"\x05value\x18\x02 \x01(\v2!.Pb.Base_Match3_HeroSkillItemInfoR\x05value:\x028\x01\"O\n" +
	"\x1dBase_Match3_HeroSkillItemInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\x05R\x02Id\x12\x1e\n" +
	"\n" +
	"TargetType\x18\x02 \x01(\x05R\n" +
	"TargetType\",\n" +
	"\x1aBase_Match3_HeroAttackInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\x05R\x02Id\"\xb8\x03\n" +
	"\x14Base_Match3_RoleInfo\x12\x0e\n" +
	"\x02Id\x18\x01 \x01(\tR\x02Id\x12\x18\n" +
	"\aChairId\x18\x02 \x01(\x05R\aChairId\x12\x1a\n" +
	"\bNickName\x18\x03 \x01(\tR\bNickName\x12\x1a\n" +
	"\bIsOnline\x18\x04 \x01(\bR\bIsOnline\x12\x1c\n" +
	"\tIsAIRobot\x18\x05 \x01(\bR\tIsAIRobot\x12\"\n" +
	"\fBindPlayerId\x18\x06 \x01(\tR\fBindPlayerId\x12\x18\n" +
	"\aIsOwner\x18\a \x01(\bR\aIsOwner\x12\"\n" +
	"\fSelectHeroId\x18\b \x01(\x05R\fSelectHeroId\x124\n" +
	"\bHeroInfo\x18\t \x01(\v2\x18.Pb.Base_Match3_HeroInfoR\bHeroInfo\x12@\n" +
	"\fSkillBarInfo\x18\n" +
	" \x01(\v2\x1c.Pb.Base_Match3_SkillBarInfoR\fSkillBarInfo\x12F\n" +
	"\x0eChessboardInfo\x18\v \x01(\v2\x1e.Pb.Base_Match3_ChessboardInfoR\x0eChessboardInfo\"1\n" +
	"\x15Base_Match3_RepeatInt\x12\x18\n" +
	"\aIntList\x18\x01 \x03(\x05R\aIntList\"S\n" +
	"\x17Base_Match3_SimpleChess\x12\x1e\n" +
	"\n" +
	"ChessColor\x18\x01 \x01(\x05R\n" +
	"ChessColor\x12\x18\n" +
	"\aSpeType\x18\x02 \x01(\x05R\aSpeType\"\xab\x01\n" +
	"\x11Base_Match3_Chess\x12\x18\n" +
	"\aChessId\x18\x01 \x01(\x05R\aChessId\x12\x1e\n" +
	"\n" +
	"ChessColor\x18\x02 \x01(\x05R\n" +
	"ChessColor\x12\x1e\n" +
	"\n" +
	"SubChessId\x18\x03 \x01(\x05R\n" +
	"SubChessId\x12\x1c\n" +
	"\tFrozenCnt\x18\x04 \x01(\x05R\tFrozenCnt\x12\x1e\n" +
	"\n" +
	"ExpireTime\x18\x05 \x01(\x03R\n" +
	"ExpireTime\"^\n" +
	"\x19Base_Match3_SupplyChesses\x12A\n" +
	"\rSupplyChesses\x18\x01 \x03(\v2\x1b.Pb.Base_Match3_SimpleChessR\rSupplyChesses\"\xb9\x02\n" +
	"\x1bBase_Match3_JieSuanRoleInfo\x12\x1e\n" +
	"\n" +
	"RankingNum\x18\x01 \x01(\x05R\n" +
	"RankingNum\x12\x0e\n" +
	"\x02Id\x18\x02 \x01(\tR\x02Id\x12\x18\n" +
	"\aChairId\x18\x03 \x01(\x05R\aChairId\x12\x1a\n" +
	"\bNickName\x18\x04 \x01(\tR\bNickName\x12[\n" +
	"\x0eRewardItemList\x18\x05 \x03(\v23.Pb.Base_Match3_JieSuanRoleInfo.RewardItemListEntryR\x0eRewardItemList\x12\x14\n" +
	"\x05IsWin\x18\x06 \x01(\bR\x05IsWin\x1aA\n" +
	"\x13RewardItemListEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\x05R\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xf7\x01\n" +
	"\x19Base_Match3_InterfereInfo\x12\x1e\n" +
	"\n" +
	"FromRoleId\x18\x01 \x01(\tR\n" +
	"FromRoleId\x12\x1c\n" +
	"\tDstRoleId\x18\x02 \x03(\tR\tDstRoleId\x12$\n" +
	"\rInterfereType\x18\x03 \x01(\x05R\rInterfereType\x12$\n" +
	"\rInterfereKeys\x18\x04 \x03(\x05R\rInterfereKeys\x12$\n" +
	"\rSkillEnergyDt\x18\x05 \x01(\x05R\rSkillEnergyDt\x12*\n" +
	"\x10BlessingEnergyDt\x18\x06 \x01(\x05R\x10BlessingEnergyDt\"^\n" +
	"\x17Net_Match3_InterfereReq\x12C\n" +
	"\rInterfereInfo\x18\x01 \x01(\v2\x1d.Pb.Base_Match3_InterfereInfoR\rInterfereInfo\"^\n" +
	"\x17Net_Match3_InterfereRet\x12C\n" +
	"\rInterfereInfo\x18\x01 \x01(\v2\x1d.Pb.Base_Match3_InterfereInfoR\rInterfereInfo\"e\n" +
	"\x1fNet_Match3_StartMatchingRoomReq\x12\x1e\n" +
	"\n" +
	"RoomTypeId\x18\x01 \x01(\x05R\n" +
	"RoomTypeId\x12\"\n" +
	"\fSelectHeroId\x18\x02 \x01(\x05R\fSelectHeroId\"3\n" +
	"\x1fNet_Match3_StartMatchingRoomRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\"\x1e\n" +
	"\x1cNet_Match3_CancelMatchingReq\"0\n" +
	"\x1cNet_Match3_CancelMatchingRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\"Z\n" +
	" Net_Match3_OtherRoleEnterRoomRet\x126\n" +
	"\tOtherRole\x18\x01 \x01(\v2\x18.Pb.Base_Match3_RoleInfoR\tOtherRole\"^\n" +
	"&Net_Match3_StartMatchingRoomSuccessRet\x124\n" +
	"\bRoomInfo\x18\x01 \x01(\v2\x18.Pb.Base_Match3_RoomInfoR\bRoomInfo\"#\n" +
	"!Net_Match3_GetSceneInformationReq\"k\n" +
	"!Net_Match3_GetSceneInformationRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x124\n" +
	"\bRoomInfo\x18\x02 \x01(\v2\x18.Pb.Base_Match3_RoomInfoR\bRoomInfo\"Y\n" +
	"\x17Net_Match3_CountdownRet\x12\x1a\n" +
	"\bTotalNum\x18\x01 \x01(\x05R\bTotalNum\x12\"\n" +
	"\fCountdownNum\x18\x02 \x01(\x05R\fCountdownNum\"\x15\n" +
	"\x13Net_Match3_StartRet\"\xc8\x01\n" +
	"\x16Net_Match3_NextMoveReq\x12\x16\n" +
	"\x06RoleId\x18\x01 \x01(\tR\x06RoleId\x12\x18\n" +
	"\aChairId\x18\x02 \x01(\x05R\aChairId\x12F\n" +
	"\x0eChessboardInfo\x18\x03 \x01(\v2\x1e.Pb.Base_Match3_ChessboardInfoR\x0eChessboardInfo\x124\n" +
	"\bHeroInfo\x18\x04 \x01(\v2\x18.Pb.Base_Match3_HeroInfoR\bHeroInfo\"\xda\x01\n" +
	"\x16Net_Match3_NextMoveRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x12\x16\n" +
	"\x06RoleId\x18\x02 \x01(\tR\x06RoleId\x12\x18\n" +
	"\aChairId\x18\x03 \x01(\x05R\aChairId\x12F\n" +
	"\x0eChessboardInfo\x18\x04 \x01(\v2\x1e.Pb.Base_Match3_ChessboardInfoR\x0eChessboardInfo\x124\n" +
	"\bHeroInfo\x18\x05 \x01(\v2\x18.Pb.Base_Match3_HeroInfoR\bHeroInfo\"\x9e\x01\n" +
	"\x1cBase_Match3_AttackTargetHero\x12\x1a\n" +
	"\bTargetId\x18\x01 \x01(\tR\bTargetId\x12 \n" +
	"\vTargetValue\x18\x02 \x01(\x05R\vTargetValue\x12\x1a\n" +
	"\bTargetHp\x18\x03 \x01(\x05R\bTargetHp\x12$\n" +
	"\rTargetHpLimit\x18\x04 \x01(\x05R\rTargetHpLimit\"\xb4\x01\n" +
	"\x18Net_Match3_HeroAttackReq\x12\x10\n" +
	"\x03AId\x18\x01 \x01(\tR\x03AId\x12\x16\n" +
	"\x06AValue\x18\x02 \x01(\x05R\x06AValue\x12\x18\n" +
	"\aSkillId\x18\x03 \x01(\x05R\aSkillId\x12T\n" +
	"\x14AttackTargetHeroList\x18\x04 \x03(\v2 .Pb.Base_Match3_AttackTargetHeroR\x14AttackTargetHeroList\"\xf4\x01\n" +
	"\x18Net_Match3_HeroAttackRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x12\x10\n" +
	"\x03AId\x18\x02 \x01(\tR\x03AId\x12\x16\n" +
	"\x06AValue\x18\x03 \x01(\x05R\x06AValue\x12\x10\n" +
	"\x03AHp\x18\x04 \x01(\x05R\x03AHp\x12\x1a\n" +
	"\bAHpLimit\x18\x05 \x01(\x05R\bAHpLimit\x12\x18\n" +
	"\aSkillId\x18\x06 \x01(\x05R\aSkillId\x12T\n" +
	"\x14AttackTargetHeroList\x18\a \x03(\v2 .Pb.Base_Match3_AttackTargetHeroR\x14AttackTargetHeroList\"/\n" +
	"-Net_Match3_WaitOtherPlayerOfflineCountdownRet\"k\n" +
	"\x1eNet_Match3_RoleDeathJieSuanRet\x12I\n" +
	"\x0fJieSuanRoleInfo\x18\x01 \x01(\v2\x1f.Pb.Base_Match3_JieSuanRoleInfoR\x0fJieSuanRoleInfo\"\xb8\x01\n" +
	"\x16Net_Match3_GameOverRet\x12A\n" +
	"\aJieSuan\x18\x01 \x03(\v2'.Pb.Net_Match3_GameOverRet.JieSuanEntryR\aJieSuan\x1a[\n" +
	"\fJieSuanEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x125\n" +
	"\x05value\x18\x02 \x01(\v2\x1f.Pb.Base_Match3_JieSuanRoleInfoR\x05value:\x028\x01\"\x18\n" +
	"\x16Net_Match3_ExitRoomReq\"B\n" +
	"\x16Net_Match3_ExitRoomRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x12\x16\n" +
	"\x06RoleId\x18\x02 \x01(\x05R\x06RoleId\"9\n" +
	"\x1fNet_Match3_OtherRoleExitRoomRet\x12\x16\n" +
	"\x06RoleId\x18\x01 \x01(\x05R\x06RoleId\"\\\n" +
	"\x1aNet_Match3_ReleaseSkillReq\x12\x18\n" +
	"\aSkillId\x18\x01 \x01(\x05R\aSkillId\x12$\n" +
	"\rSkillPosition\x18\x02 \x01(\x05R\rSkillPosition\"\x1c\n" +
	"\x1aNet_Match3_ReleaseSkillRet\"\x19\n" +
	"\x17Net_Match3_EnterRoomReq\"a\n" +
	"\x17Net_Match3_EnterRoomRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x124\n" +
	"\bRoomInfo\x18\x02 \x01(\v2\x18.Pb.Base_Match3_RoomInfoR\bRoomInfo\"5\n" +
	"\x15Net_Match3_PrepareReq\x12\x1c\n" +
	"\tIsPrepare\x18\x01 \x01(\bR\tIsPrepare\"M\n" +
	"\x15Net_Match3_PrepareRet\x12\x16\n" +
	"\x06RoleId\x18\x01 \x01(\x05R\x06RoleId\x12\x1c\n" +
	"\tIsPrepare\x18\x02 \x01(\bR\tIsPrepare\"D\n" +
	"\x1cNet_Match3_BuyTalentSkillReq\x12$\n" +
	"\rTalentSkillId\x18\x01 \x01(\x05R\rTalentSkillId\"V\n" +
	"\x1cNet_Match3_BuyTalentSkillRet\x12\x10\n" +
	"\x03Ret\x18\x01 \x01(\x05R\x03Ret\x12$\n" +
	"\rTalentSkillId\x18\x02 \x01(\x05R\rTalentSkillId\"\xd4\x01\n" +
	" Net_Match3_NextRoundOperationRet\x12 \n" +
	"\vMaxRoundNum\x18\x01 \x01(\x05R\vMaxRoundNum\x12(\n" +
	"\x0fCurrentRoundNum\x18\x02 \x01(\x05R\x0fCurrentRoundNum\x12,\n" +
	"\x11OperationPlayerId\x18\x03 \x01(\tR\x11OperationPlayerId\x126\n" +
	"\x16OperationPlayerEndTime\x18\x04 \x01(\x03R\x16OperationPlayerEndTime*\xaa\x01\n" +
	"\n" +
	"Match3Game\x12\f\n" +
	"\bGameIdle\x10\x00\x12\x0e\n" +
	"\tGame10101\x10\xf5N\x12\x0e\n" +
	"\tGame10201\x10\xd9O\x12\x0e\n" +
	"\tGame10202\x10\xdaO\x12\x0e\n" +
	"\tGame10301\x10\xbdP\x12\x0e\n" +
	"\tGame10401\x10\xa1Q\x12\x0e\n" +
	"\tGame10402\x10\xa2Q\x12\x0e\n" +
	"\tGame10403\x10\xa3Q\x12\x0e\n" +
	"\tGame10404\x10\xa4Q\x12\x0e\n" +
	"\tGame10501\x10\x85RB\x06Z\x04./pbb\x06proto3"

var (
	file_Net_Match3_proto_rawDescOnce sync.Once
	file_Net_Match3_proto_rawDescData []byte
)

func file_Net_Match3_proto_rawDescGZIP() []byte {
	file_Net_Match3_proto_rawDescOnce.Do(func() {
		file_Net_Match3_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_Net_Match3_proto_rawDesc), len(file_Net_Match3_proto_rawDesc)))
	})
...
var file_Net_Match3_proto_goTypes = []any{
...
func file_Net_Match3_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_Net_Match3_proto_rawDesc), len(file_Net_Match3_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   60,
			NumExtensions: 0,
			NumServices:   0,
